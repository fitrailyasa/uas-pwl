...
function EditTransaksi() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('transaksi updated successfully', response.data);
        } catch (error) {
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="mb-3">
                                ...
                                <img className="img-fluid mb-3" style={{ maxHeight: '200px' }} src={formData.gambar} alt="Gambar transaksi" />
                                <input
                                    type="file"
